...
/// @param channel The channel where the delivery receipt updated.
- (void)channelDidReceiveDeliveryReceipt:(nonnull SCTChannel *)channel
NS_SWIFT_NAME(channelDidReceiveDeliveryReceipt(_:));

/// A callback when read receipts updated.
/// @param channel The channel where the read receipt updated.
- (void)channelDidReceiveReadReceipt:(nonnull SCTChannel *)channel
NS_SWIFT_NAME(channelDidReceiveReadReceipt(_:));
